...
class ResNet(nn.Module):
    def __init__(
        ...
        self.fc1 = nn.Linear(512 * block.expansion * 2 + 100, 100)
    ...
    def forward(self, query_x: Tensor, feature_list: list = None, data_manager_obj = None, batch_y = None,  mode ="train") -> Tensor:
        ...
        predictions = predictions[:, data_manager_obj.selected_classes]  
