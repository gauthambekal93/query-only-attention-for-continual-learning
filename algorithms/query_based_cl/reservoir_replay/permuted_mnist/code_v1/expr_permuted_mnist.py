...
def import_modules():
    ...
    from algorithms.query_based_cl.reservoir_replay.permuted_mnist.code_v1.data_manager import DataManager 
    from algorithms.query_based_cl.reservoir_replay.permuted_mnist.code_v1.runner import Runner 
    from algorithms.query_based_cl.reservoir_replay.permuted_mnist.code_v1.checkpoint_manager import CheckpointManager 
    from algorithms.query_based_cl.reservoir_replay.permuted_mnist.code_v1.neural_networks import ERNetwork
...
if __name__ == '__main__':
    ...
    model_config_path = os.path.join( ROOT, "configuration_files","permuted_mnist", "models", "query_based_cl", "reservoir_replay","0.json") 
