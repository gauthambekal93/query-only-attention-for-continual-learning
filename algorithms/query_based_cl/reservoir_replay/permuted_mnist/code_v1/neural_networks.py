...
class ERNetwork(nn.Module):
    ...
    def forward_prediction(self, data_manager_obj, query_x):
        support_x , support_y = data_manager_obj.get_data(buffer_type = "fifo")
        return self.classify_images(query_x, support_x, support_y )
    
    
    def backward_prediction(self, data_manager_obj, query_x):
        support_x , support_y = data_manager_obj.get_data(buffer_type = "reservoir")
        return self.classify_images(query_x, support_x, support_y )
