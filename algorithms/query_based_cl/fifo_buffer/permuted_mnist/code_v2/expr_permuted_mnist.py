...
def import_modules():
    ...
    from algorithms.query_based_cl.fifo_buffer.permuted_mnist.code_v2.data_manager import DataManager 
    from algorithms.query_based_cl.fifo_buffer.permuted_mnist.code_v2.runner import Runner 
    from algorithms.query_based_cl.fifo_buffer.permuted_mnist.code_v2.checkpoint_manager import CheckpointManager 
    from algorithms.query_based_cl.fifo_buffer.permuted_mnist.code_v2.neural_networks import ERNetwork
