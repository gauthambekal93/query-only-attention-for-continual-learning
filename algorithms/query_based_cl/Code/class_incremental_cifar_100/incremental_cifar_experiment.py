...
def import_modules():
    ...
    from algorithms.query_based_cl.Code.class_incremental_cifar_100.data_manager import DataManager 
    from algorithms.query_based_cl.Code.class_incremental_cifar_100.runner import Runner 
    from algorithms.query_based_cl.Code.class_incremental_cifar_100.checkpoint_manager import CheckpointManager 

    from algorithms.query_based_cl.Code.class_incremental_cifar_100.torchvision_modified_resnet import build_resnet18, kaiming_init_resnet_module
...
if __name__ == '__main__':
    ...
    model_config_path = os.path.join( ROOT, "configuration_files","cifar_100", "models", "query_based_cl", "0.json") 
