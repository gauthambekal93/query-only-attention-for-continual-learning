...
def expr(model_params , data_params):
    ...
    relation_network = RN(input_features= 128 * 3 * 3 * 2  , num_features=num_features, num_outputs=num_outputs, num_hidden_layers=num_hidden_layers, 
...
if __name__ == '__main__':
    ...
    model_config_path = os.path.join(project_root, "configuration_files", "split_image_net", "models","query_based_cl", "2.json") 
