...
def import_modules():
    ...
    from algorithms.query_based_cl_V10.Code.tiny_image_net.data_manager import DataManager 
    from algorithms.query_based_cl_V10.Code.tiny_image_net.runner import Runner 
    from algorithms.query_based_cl_V10.Code.tiny_image_net.checkpoint_manager import CheckpointManager 

    from algorithms.query_based_cl_V10.Code.tiny_image_net.torchvision_modified_resnet import build_resnet18, kaiming_init_resnet_module
...
if __name__ == '__main__':
    ...
    model_config_path = os.path.join( ROOT, "configuration_files","tiny_image_net", "models", "query_based_cl_V10", "2.json") 
