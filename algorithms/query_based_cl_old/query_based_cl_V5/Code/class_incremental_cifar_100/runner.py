    ...
    def train(self, train_context, data_manager_obj, checkpoint_obj):
        ...
        for epoch in tqdm( range(self.epochs_per_task)):
            ...
            for batch_no in range( no_of_batches ): 
                ...
                predictions = train_context.net.forward( batch_x, data_manager_obj = data_manager_obj, batch_y = batch_y, mode = "train")
                
                #batch_y = batch_y[:, data_manager_obj.selected_classes].argmax(dim =1)
