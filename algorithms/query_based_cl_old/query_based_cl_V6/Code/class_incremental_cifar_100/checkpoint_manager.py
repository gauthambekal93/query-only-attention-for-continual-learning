...
class CheckpointManager:
    ...
    def __init__(self, data_manager_obj, runner_obj, root, running_avg_window, model_dir ):
        ...
        self.results_dict["sub_task_accuracies"] = data_manager_obj.total_tasks * [None]
    ...
    def summarize_train(self):
        ...
        #print("Train Loss ",self.results_dict["train_loss_per_checkpoint"][self.current_running_avg_step].item())
    ...
    def summarize_test(self,  current_accuracy, sub_task_accuracies, current_task_id, current_num_classes):     
        ...
        self.results_dict["test_accuracy_per_task"][current_task_id] = 100 * current_accuracy 
        self.results_dict["sub_task_accuracies"][current_task_id] = { task_id: 100*accuracy for task_id, accuracy in sub_task_accuracies.items() }
