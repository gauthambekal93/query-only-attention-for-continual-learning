...
class ResNet(nn.Module):
    ...
    def generate_score(self, query_x, support_x, support_y):
    ...
    def forward(self, query_x: Tensor, feature_list: list = None, data_manager_obj = None) -> Tensor:
        ...
        support_x , support_y = data_manager_obj.get_support_indices()
        
        query_x = self._forward_impl( query_x , feature_list)
        
        support_x = self._forward_impl( support_x , feature_list)
        
        return self.generate_score( query_x, support_x, support_y)
