...
class Runner:
    ...
    def evaluvate_network(self, epoch, train_context, data_manager_obj, checkpoint_obj):
        ...
        print("Task Id:" , data_manager_obj.current_task_id, "Test Accuracy", avg_acc / num_test_batches  )
        #checkpoint_obj.summarize_test(avg_acc / num_test_batches,  data_manager_obj.current_task_id, data_manager_obj.current_num_classes )
    ...
    def train(self, train_context, data_manager_obj, checkpoint_obj):
        ...
        for epoch in tqdm( range(self.epochs_per_task)):
            ...
            for batch_no in range( no_of_batches ): 
                ...
                predictions = train_context.net.forward( batch_x, data_manager_obj = data_manager_obj, mode = "train") #[:, data_manager_obj.selected_classes] 
