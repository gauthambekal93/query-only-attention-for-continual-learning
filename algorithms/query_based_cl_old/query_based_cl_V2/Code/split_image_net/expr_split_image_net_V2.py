...
sys.path.append("C:/Users/gauthambekal93/Research/continual_learning/loss_of_plasticity_and_forgetting/algorithms/query_based_cl/Code/split_image_net")
...
def expr(model_params , data_params):
    ...
    relation_network = RN(input_features= 128 * 3 * 3 * 2 + classes_per_task , num_features=num_features, num_outputs=num_outputs, num_hidden_layers=num_hidden_layers, 
    ...
    for task_idx in (range(num_tasks)):
        ...
        data_dict_val = generate_test_data(data_dict_train, image_net_val_x, image_net_val_y, label_1, label_2 , images_per_class_val, classes_per_task )
...
def import_modules():
    ...
    from relation_network_split_image_net_V2 import RN
...
if __name__ == '__main__':
    ...
    model_config_path = os.path.join(project_root, "configuration_files", "split_image_net", "models","query_based_cl", "3.json") 
