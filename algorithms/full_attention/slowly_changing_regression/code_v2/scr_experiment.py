...
def import_modules():    
    ...
    from algorithms.full_attention.slowly_changing_regression.code_v2.data_manager import DataManager 
    from algorithms.full_attention.slowly_changing_regression.code_v2.runner import Runner 
    from algorithms.full_attention.slowly_changing_regression.code_v2.checkpoint_manager import CheckpointManager 

    from algorithms.full_attention.slowly_changing_regression.code_v2.neural_net import feed_forward_nn
