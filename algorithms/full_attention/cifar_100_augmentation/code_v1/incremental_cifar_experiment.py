...
def import_modules():
    ...
    from algorithms.full_attention.cifar_100_augmentation.code_v1.data_manager import DataManager 
    from algorithms.full_attention.cifar_100_augmentation.code_v1.runner import Runner 
    from algorithms.full_attention.cifar_100_augmentation.code_v1.checkpoint_manager import CheckpointManager 
    from algorithms.full_attention.cifar_100_augmentation.code_v1.torchvision_modified_resnet import build_resnet18, kaiming_init_resnet_module
