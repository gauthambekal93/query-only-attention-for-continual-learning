...
def import_modules():
    ...
    from algorithms.experience_replay.fifo_replay.cifar_100_non_permuted.data_manager import DataManager 
    from algorithms.experience_replay.fifo_replay.cifar_100_non_permuted.runner import Runner 
    from algorithms.experience_replay.fifo_replay.cifar_100_non_permuted.checkpoint_manager import CheckpointManager 

    from algorithms.experience_replay.fifo_replay.cifar_100_non_permuted.torchvision_modified_resnet import build_resnet18, kaiming_init_resnet_module
...
if __name__ == '__main__':
    ...
    model_config_path = os.path.join( ROOT, "configuration_files","cifar_100", "models", "experience_replay", "1.json") 
