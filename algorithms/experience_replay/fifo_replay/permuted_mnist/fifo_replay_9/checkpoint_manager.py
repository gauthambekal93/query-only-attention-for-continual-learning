...
class CheckpointManager:
    ...
    def __init__(self, data_manager_obj, runner_obj, root, model_dir ):
        ...
        self.results_dict["last_few_accuracy"] = {}
    ...
    def save_result_checkpoint(self,  data_manager_obj, train_loss, train_accuracy, last_few_accuracy, forward_accuracy, backward_accuracy):
        ...
        try:
            ...
            self.results_dict["last_few_accuracy"][current_task_id] = last_few_accuracy
