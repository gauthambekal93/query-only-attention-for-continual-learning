...
def import_modules():
    ...
    from algorithms.experience_replay.Code.permuted_mnist.fifo_replay_1.data_manager import DataManager 
    from algorithms.experience_replay.Code.permuted_mnist.fifo_replay_1.runner import Runner 
    from algorithms.experience_replay.Code.permuted_mnist.fifo_replay_1.checkpoint_manager import CheckpointManager 
    from algorithms.experience_replay.Code.permuted_mnist.fifo_replay_1.neural_networks import ERNetwork
...
if __name__ == '__main__':
    ...
    model_config_path = os.path.join( ROOT, "configuration_files","permuted_mnist", "models", "experience_replay", "fifo_replay","1.json") 
