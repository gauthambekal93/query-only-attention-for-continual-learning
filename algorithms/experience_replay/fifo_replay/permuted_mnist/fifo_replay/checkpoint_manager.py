...
class CheckpointManager:
    ...
    def save_result_checkpoint(self,  data_manager_obj, train_loss, train_accuracy, forward_accuracy, backward_accuracy):
        ...
        try:
            ...
            self.results_dict["task_train_y_one_hot"] = copy.deepcopy ( data_manager_obj.task_train_y_one_hot)
            ...
            self.results_dict["task_test_y_one_hot"] = copy.deepcopy ( data_manager_obj.task_test_y_one_hot)
            ...
            self.results_dict["buffer_y_one_hot"] = copy.deepcopy(data_manager_obj.buffer_y_one_hot)
    ...
    def load_experiment_checkpoint(self, train_context, data_manager_obj):
        ...
        if os.path.exists(self.result_path):        
            ...
            data_manager_obj.task_y_one_hot  = self.results_dict["task_train_y_one_hot"]
            ...
            data_manager_obj.task_test_y_one_hot  = self.results_dict["task_test_y_one_hot"]
            ...
            data_manager_obj.buffer_y_one_hot =  self.results_dict["buffer_y_one_hot"]
