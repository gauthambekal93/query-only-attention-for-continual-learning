...
def import_modules():
    ...
    from algorithms.experience_replay.Code.permuted_mnist.fifo_replay_6.data_manager import DataManager 
    from algorithms.experience_replay.Code.permuted_mnist.fifo_replay_6.runner import Runner 
    from algorithms.experience_replay.Code.permuted_mnist.fifo_replay_6.checkpoint_manager import CheckpointManager 
    from algorithms.experience_replay.Code.permuted_mnist.fifo_replay_6.neural_networks import ERNetwork
...
class TrainContext:
    def __init__(self, input_size, num_features, classes_per_task, num_hidden_layers, step_size, momentum, weight_decay, total_classes):
...
class PermutedMNISTExperiment:
    ...
    def initialize_model(self):
         self.train_context =  TrainContext(self.input_size, self.num_features, self.classes_per_task, self.num_hidden_layers, 
                                            self.step_size, self.momentum, self.weight_decay, self.total_classes)
...
if __name__ == '__main__':
    ...
    model_config_path = os.path.join( ROOT, "configuration_files","permuted_mnist", "models", "experience_replay", "fifo_replay","6.json") 
