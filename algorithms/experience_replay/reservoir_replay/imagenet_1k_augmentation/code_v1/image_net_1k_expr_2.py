...
def import_modules():
    ...
    from algorithms.experience_replay.reservoir_replay.imagenet_1k_augmentation.code_v1.data_manager import DataManager 
    from algorithms.experience_replay.reservoir_replay.imagenet_1k_augmentation.code_v1.runner import Runner 
    from algorithms.experience_replay.reservoir_replay.imagenet_1k_augmentation.code_v1.checkpoint_manager import CheckpointManager 

    from algorithms.experience_replay.reservoir_replay.imagenet_1k_augmentation.code_v1.torchvision_modified_resnet import build_resnet18, kaiming_init_resnet_module
