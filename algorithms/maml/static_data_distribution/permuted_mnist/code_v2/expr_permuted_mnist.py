...
def import_modules():
    ...
    from algorithms.maml.static_data_distribution.permuted_mnist.code_v2.data_manager import DataManager 
    from algorithms.maml.static_data_distribution.permuted_mnist.code_v2.runner import Runner 
    from algorithms.maml.static_data_distribution.permuted_mnist.code_v2.checkpoint_manager import CheckpointManager 
    from algorithms.maml.static_data_distribution.permuted_mnist.code_v2.neural_networks import ERNetwork
