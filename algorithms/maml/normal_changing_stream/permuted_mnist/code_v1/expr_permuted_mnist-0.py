...
def import_modules():
    ...
    from algorithms.maml.normal_changing_stream.permuted_mnist.code_v1.data_manager import DataManager 
    from algorithms.maml.normal_changing_stream.permuted_mnist.code_v1.runner import Runner 
    from algorithms.maml.normal_changing_stream.permuted_mnist.code_v1.checkpoint_manager import CheckpointManager 
    from algorithms.maml.normal_changing_stream.permuted_mnist.code_v1.neural_networks import ERNetwork
