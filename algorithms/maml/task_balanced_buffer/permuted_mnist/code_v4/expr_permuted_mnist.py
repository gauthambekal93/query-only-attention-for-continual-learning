...
def import_modules():
    ...
    from algorithms.maml.task_balanced_buffer.permuted_mnist.code_v4.data_manager import DataManager 
    from algorithms.maml.task_balanced_buffer.permuted_mnist.code_v4.runner import Runner 
    from algorithms.maml.task_balanced_buffer.permuted_mnist.code_v4.checkpoint_manager import CheckpointManager 
    from algorithms.maml.task_balanced_buffer.permuted_mnist.code_v4.neural_networks import ERNetwork
