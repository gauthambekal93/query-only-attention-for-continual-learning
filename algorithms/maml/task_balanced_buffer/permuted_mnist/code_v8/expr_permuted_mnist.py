...
def import_modules():
    ...
    from algorithms.maml.task_balanced_buffer.permuted_mnist.code_v8.data_manager import DataManager 
    from algorithms.maml.task_balanced_buffer.permuted_mnist.code_v8.runner import Runner 
    from algorithms.maml.task_balanced_buffer.permuted_mnist.code_v8.checkpoint_manager import CheckpointManager 
    from algorithms.maml.task_balanced_buffer.permuted_mnist.code_v8.neural_networks import ERNetwork
