...
def import_modules():
    ...
    from algorithms.maml.task_balanced_buffer.permuted_mnist.code_v3.data_manager import DataManager 
    from algorithms.maml.task_balanced_buffer.permuted_mnist.code_v3.runner import Runner 
    from algorithms.maml.task_balanced_buffer.permuted_mnist.code_v3.checkpoint_manager import CheckpointManager 
    from algorithms.maml.task_balanced_buffer.permuted_mnist.code_v3.neural_networks import ERNetwork
...
if __name__ == '__main__':
    ...
    config_path = os.path.join( experiment_dir, "configuration-7.json") 
