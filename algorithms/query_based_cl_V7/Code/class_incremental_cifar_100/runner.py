...
class Runner:
    ...
    def test_network(self, train_context, data_manager_obj, checkpoint_obj):
         ...
         with torch.no_grad():
             ...
             for task_id in data_manager_obj.task_test_x.keys():
                 ...
                 predictions = train_context.net.forward(batch_x, data_manager_obj = data_manager_obj, batch_y = batch_y).to(train_context.device) 
    ...
    def val_network(self, train_context, data_manager_obj, checkpoint_obj):
         ...
         with torch.no_grad():
             task_id = data_manager_obj.current_task_id - 5
    ...
    def run(self, train_context, data_manager_obj, checkpoint_obj):
        ...
        while data_manager_obj.current_task_id < 50000: #data_manager_obj.total_tasks:
            ...
            if data_manager_obj.current_task_id >=5:
        ...
        #torch.save(checkpoint, r"C:/Users/gauthambekal93/Research/query-only-attention-for-continual-learning/results/cifar_100/query_based_cl_V7/0/0/model_5_way_classification_20_support.pkl" ) 
        
        #checkpoint = torch.load(r"C:/Users/gauthambekal93/Research/query-only-attention-for-continual-learning/results/cifar_100/query_based_cl_V7/0/0/model_5_way_classification_20_support.pkl" ,  map_location = train_context.device)
