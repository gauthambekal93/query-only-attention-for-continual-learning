    ...
    def test_network(self, epoch, train_context, data_manager_obj, checkpoint_obj):
         ...
         with torch.no_grad():
             ...
             for task_id in data_manager_obj.task_test_x.keys():
                 ...
                 predictions = train_context.net.forward(batch_x, data_manager_obj = data_manager_obj, batch_y = batch_y ).to(train_context.device) [:, data_manager_obj.selected_classes]
    ...
    def train(self, train_context, data_manager_obj, checkpoint_obj):
        ...
        for epoch in tqdm( range(self.epochs_per_task)):
            ...
            for batch_no in range( no_of_batches ): 
                ...
                predictions = train_context.net.forward( batch_x, data_manager_obj = data_manager_obj, batch_y = batch_y) [:, data_manager_obj.selected_classes] 
