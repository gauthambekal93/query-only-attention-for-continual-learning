...
def import_modules():
    ...
    from algorithms.matching_network.fifo_buffer.permuted_mnist.code_v3.data_manager import DataManager 
    from algorithms.matching_network.fifo_buffer.permuted_mnist.code_v3.runner import Runner 
    from algorithms.matching_network.fifo_buffer.permuted_mnist.code_v3.checkpoint_manager import CheckpointManager 
    from algorithms.matching_network.fifo_buffer.permuted_mnist.code_v3.neural_networks import ERNetwork
