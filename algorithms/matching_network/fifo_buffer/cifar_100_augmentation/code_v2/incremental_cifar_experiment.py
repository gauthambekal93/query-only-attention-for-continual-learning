...
def import_modules():
    ...
    from algorithms.matching_network.fifo_buffer.cifar_100_augmentation.code_v2.data_manager import DataManager 
    from algorithms.matching_network.fifo_buffer.cifar_100_augmentation.code_v2.runner import Runner 
    from algorithms.matching_network.fifo_buffer.cifar_100_augmentation.code_v2.checkpoint_manager import CheckpointManager 
    from algorithms.matching_network.fifo_buffer.cifar_100_augmentation.code_v2.torchvision_modified_resnet import build_resnet18, kaiming_init_resnet_module
