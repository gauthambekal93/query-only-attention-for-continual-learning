...
def import_modules():
    ...
    from algorithms.query_based_cl_V3.Code.class_incremental_cifar_100.data_manager import DataManager 
    from algorithms.query_based_cl_V3.Code.class_incremental_cifar_100.runner import Runner 
    from algorithms.query_based_cl_V3.Code.class_incremental_cifar_100.checkpoint_manager import CheckpointManager 

    from algorithms.query_based_cl_V3.Code.class_incremental_cifar_100.torchvision_modified_resnet import build_resnet18, kaiming_init_resnet_module
...
class IncrementalCIFARExperiment:
    ...
    def initialize_data_manager(self):
         self.data_manager_obj = DataManager(root = ROOT, data_dir = self.data_dir, num_images_per_class = self.num_images_per_class , 
                                             ...
                                             buffer_size = self.buffer_size, num_support_per_label = self.num_support_per_label, 
...
if __name__ == '__main__':
    ...
    model_config_path = os.path.join( ROOT, "configuration_files","cifar_100", "models", "query_based_cl_V3", "0.json") 
