...
def import_modules():
    ...
    from algorithms.dark_experience_replay.reservoir_replay.cifar_100_augmentation.code_v1.data_manager import DataManager 
    from algorithms.dark_experience_replay.reservoir_replay.cifar_100_augmentation.code_v1.runner import Runner 
    from algorithms.dark_experience_replay.reservoir_replay.cifar_100_augmentation.code_v1.checkpoint_manager import CheckpointManager 

    from algorithms.dark_experience_replay.reservoir_replay.cifar_100_augmentation.code_v1.torchvision_modified_resnet import build_resnet18, kaiming_init_resnet_module
