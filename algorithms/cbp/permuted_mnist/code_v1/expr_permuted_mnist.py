...
def import_modules():
    ...
    from algorithms.cbp.permuted_mnist.code_v1.data_manager import DataManager 
    from algorithms.cbp.permuted_mnist.code_v1.runner import Runner 
    from algorithms.cbp.permuted_mnist.code_v1.checkpoint_manager import CheckpointManager 
    from algorithms.cbp.permuted_mnist.code_v1.neural_networks import ERNetwork
    
    from algorithms.cbp.permuted_mnist.code_v1.cbp import ContinualBackprop
    from algorithms.cbp.permuted_mnist.code_v1.deep_ffnn import DeepFFNN
    
    global  ERNetwork, DataManager, Runner, CheckpointManager, DeepFFNN, ContinualBackprop
