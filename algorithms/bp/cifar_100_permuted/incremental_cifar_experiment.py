...
def import_modules():
    ...
    from algorithms.bp.cifar_100_permuted.data_manager import DataManager 
    from algorithms.bp.cifar_100_permuted.runner import Runner 
    from algorithms.bp.cifar_100_permuted.checkpoint_manager import CheckpointManager 

    from algorithms.bp.cifar_100_permuted.torchvision_modified_resnet import build_resnet18, kaiming_init_resnet_module
