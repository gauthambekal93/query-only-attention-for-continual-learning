...
class IncrementalCIFARExperiment:
    ...
    def __init__(self, data_params, model_params):
        ...
        #self.epochs_per_task = int( self.num_epochs / self.total_tasks )
    ...
    inital_num_classes =self.inital_num_classes, class_increase_per_task = self.class_increase_per_task ,
    ...
    ''' 
    epochs_per_task = self.epochs_per_task, total_tasks = self.total_tasks, train_batch_size = self.train_batch_size,
    num_images_per_class
    class_increase_per_task
    '''
