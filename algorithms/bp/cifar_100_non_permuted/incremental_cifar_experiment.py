...
def import_modules():
    ...
    from algorithms.bp.cifar_100_non_permuted.data_manager import DataManager 
    from algorithms.bp.cifar_100_non_permuted.runner import Runner 
    from algorithms.bp.cifar_100_non_permuted.checkpoint_manager import CheckpointManager 

    from algorithms.bp.cifar_100_non_permuted.torchvision_modified_resnet import build_resnet18, kaiming_init_resnet_module
...
if __name__ == '__main__':
    ...
    model_config_path = os.path.join( ROOT, "configuration_files","cifar_100", "models", "bp", "1.json") 
