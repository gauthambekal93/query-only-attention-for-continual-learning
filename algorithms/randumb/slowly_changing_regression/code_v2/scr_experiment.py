...
def import_modules():    
    ...
    from algorithms.query_based_cl.fifo_buffer.slowly_changing_regression.code_v2.data_manager import DataManager 
    from algorithms.query_based_cl.fifo_buffer.slowly_changing_regression.code_v2.runner import Runner 
    from algorithms.query_based_cl.fifo_buffer.slowly_changing_regression.code_v2.checkpoint_manager import CheckpointManager 

    from algorithms.query_based_cl.fifo_buffer.slowly_changing_regression.code_v2.neural_net import feed_forward_nn
