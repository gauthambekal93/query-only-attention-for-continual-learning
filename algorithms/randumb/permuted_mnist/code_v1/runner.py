...
class Runner:
    ...
    def train(self, train_context, data_manager_obj, checkpoint_obj):
        ...
        train_accuracy, prequential_accuracy = [], [], []
        ...
        for i in range(0, train_x.shape[0], self.num_datapoints_per_timestep ):
            ...
            train_context.net.track_estimates( batch_x, batch_y)
       ...
       # train_loss= torch.stack(train_loss).mean().item()
        ...
        print("task id ", data_manager_obj.current_task_id,  "Train accuracy: ", train_accuracy,
              "Prequential accuracy", prequential_accuracy, "Forward accuracy: ", forward_accuracy,  "Backward accuracy: ", backward_accuracy )
        
        return train_accuracy, prequential_accuracy, forward_accuracy, backward_accuracy
    ...
    def run(self, train_context, data_manager_obj, checkpoint_obj):
        ...
        while data_manager_obj.current_task_id < data_manager_obj.num_tasks: 
            ...
            if  ( data_manager_obj.current_task_id >= data_manager_obj.num_old_task_window ) :
                ...
                train_accuracy, prequential_accuracy, forward_accuracy, backward_accuracy = self.train( train_context, data_manager_obj, checkpoint_obj)
                
                checkpoint_obj.save_model_checkpoint( train_context, data_manager_obj, data_manager_obj.current_task_id)
                
                checkpoint_obj.save_result_checkpoint(data_manager_obj, train_accuracy, prequential_accuracy, forward_accuracy, backward_accuracy)
