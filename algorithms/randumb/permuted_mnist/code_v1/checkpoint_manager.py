...
class CheckpointManager:
    ...
    def save_result_checkpoint(self,  data_manager_obj, train_accuracy, prequential_accuracy, forward_accuracy, backward_accuracy):
    ...
    def save_model_checkpoint(self, train_context, data_manager_obj, current_task_id):
