...
def import_modules():
    ...
    from algorithms.randumb.permuted_mnist.code_v1.data_manager import DataManager 
    from algorithms.randumb.permuted_mnist.code_v1.runner import Runner 
    from algorithms.randumb.permuted_mnist.code_v1.checkpoint_manager import CheckpointManager 
    #from algorithms.randumb.permuted_mnist.code_v1.neural_networks import ERNetwork
    from algorithms.randumb.permuted_mnist.code_v1.randumb import RanDumb
    
    global  ERNetwork, DataManager, Runner, CheckpointManager, RanDumb
...
class TrainContext:
    def __init__(self, input_size, num_features, classes_per_task, num_hidden_layers, step_size, weight_decay, total_classes):
        ...
        self.net = RanDumb(input_size, num_outputs = total_classes, num_features=25000, gamma=1.0, ridge=1e-6, device=self.device )
