...
class Runner:
    ...
    def __init__(self, num_datapoints_per_timestep, test_batch_size, ewc_lambda):
    ...
    def train(self, train_context, data_manager_obj, checkpoint_obj):
        ...
        for i in range(0, train_x.shape[0], self.num_datapoints_per_timestep ):
            ...
            if self.full_counter % 60000 == 0: #was 1000, 50000
                train_context.net.update_fisher(batch_x, batch_y)

            if self.full_counter % 200000   == 0: #was 20000, 800000
