...
def import_modules():    
    ...
    from algorithms.ewc.slowly_changing_regression.code_v1.data_manager import DataManager 
    from algorithms.ewc.slowly_changing_regression.code_v1.runner import Runner 
    from algorithms.ewc.slowly_changing_regression.code_v1.checkpoint_manager import CheckpointManager 

    from algorithms.ewc.slowly_changing_regression.code_v1.neural_net import feed_forward_nn
