# -*- coding: utf-8 -*-
"""
Created on Sun Mar 15 21:27:03 2026
...
lr_index, runs, NUM_TASKS, average_over = "0" , ["1"] , 50000, 100
base_path = os.path.join(project_root, "results", "cifar_100", "bp")

fwd_bp_replay, fwd_bp_std  = calculate_curve(base_path, runs, lr_index, "forward_accuracy",  NUM_TASKS, average_over)
prequential_bp_replay, prequential_bp_std  = calculate_curve(base_path, runs, lr_index, "prequential_accuracy",  NUM_TASKS, average_over)
bwd_bp_replay, bwd_bp_std  = calculate_curve(base_path, runs, lr_index, "backward_accuracy",  NUM_TASKS, average_over)



plot_graph({ 
            "Forward Accurcy":  (fwd_bp_replay, fwd_bp_std, {"color":"red", "linestyle": "-",  "marker": "d"}),
            "Prequential Accuracy":  (prequential_bp_replay, prequential_bp_std, {"color":"green", "linestyle": "-",  "marker": "s"}),
            "Backward Accurcy":  (bwd_bp_replay, bwd_bp_std, {"color":"blue", "linestyle": "-",  "marker": "x"}),
            },
             title="Non - Permuted CIFAR 100 - BP - 2000",)
...
plot_graph({ 
            ...
            "Backward Accurcy":  (bwd_bp_replay, bwd_bp_std, {"color":"blue", "linestyle": "-",  "marker": "x"}),
             ...
             title="Permuted CIFAR 100 - BP - 2000",)




lr_index, runs, NUM_TASKS, average_over = "0" , ["0"] , 50000, 100
base_path = os.path.join(project_root, "results", "cifar_100", "permuted", "experience_replay", "reservoir_replay")
...
plot_graph({ 
            ...
            "Backward Accurcy":  (bwd_er_replay, bwd_er_std, {"color":"blue", "linestyle": "-",  "marker": "x"}),
             ...
             title="Permuted CIFAR 100 - Experience replay Reservoir Buffer - 2000",)
...
lr_index, runs, NUM_TASKS, average_over = "0" , ["0"] , 50000, 100
base_path = os.path.join(project_root, "results", "cifar_100", "permuted", "query_based_cl", "task_balanced_replay")

fwd_query_based_acc, fwd_query_based_std  = calculate_curve(base_path, runs, lr_index, "forward_accuracy",  NUM_TASKS, average_over)
prequential_query_based_acc, prequential_query_based_std  = calculate_curve(base_path, runs, lr_index, "prequential_accuracy",  NUM_TASKS, average_over)
bwd_query_based_acc, bwd_query_based_std  = calculate_curve(base_path, runs, lr_index, "backward_accuracy",  NUM_TASKS, average_over)



plot_graph({ 
            "Forward Accurcy":  (fwd_query_based_acc, fwd_query_based_std, {"color":"red", "linestyle": "-",  "marker": "d"}),
            "Prequential Accuracy":  (prequential_query_based_acc, prequential_query_based_std, {"color":"green", "linestyle": "-",  "marker": "s"}),
            "Backward Accurcy":  (bwd_query_based_acc, bwd_query_based_std, {"color":"blue", "linestyle": "-",  "marker": "x"}),
            },
             title="Permuted CIFAR 100 - Query only attention with balanced task buffer - 2000",)


#THIS WAS THE BEST ONE TILL NOW, BUT DUE TO UNKNOWN REASON i FOUND THAT FIFO USED BUFFER SIZE OF 1000
lr_index, runs, NUM_TASKS, average_over = "0" , ["1"] , 50000, 10
base_path = os.path.join(project_root, "results", "cifar_100", "permuted", "query_based_cl", "task_balanced_replay")
...
lr_index, runs, NUM_TASKS, average_over = "0" , ["2"] , 50000, 1
base_path = os.path.join(project_root, "results", "cifar_100", "permuted", "query_based_cl", "task_balanced_replay")

fwd_query_based_acc_2, fwd_query_based_std_2  = calculate_curve(base_path, runs, lr_index, "forward_accuracy",  NUM_TASKS, average_over)
prequential_query_based_acc_2, prequential_query_based_std_2  = calculate_curve(base_path, runs, lr_index, "prequential_accuracy",  NUM_TASKS, average_over)
bwd_query_based_acc_2, bwd_query_based_std_2  = calculate_curve(base_path, runs, lr_index, "backward_accuracy",  NUM_TASKS, average_over)




lr_index, runs, NUM_TASKS, average_over = "0" , ["0"] , 50000, 1
base_path = os.path.join(project_root, "results", "cifar_100", "permuted", "query_based_cl", "task_balanced_replay")

fwd_query_based_acc_0, fwd_query_based_std_0  = calculate_curve(base_path, runs, lr_index, "forward_accuracy",  NUM_TASKS, average_over)
prequential_query_based_acc_0, prequential_query_based_std_0  = calculate_curve(base_path, runs, lr_index, "prequential_accuracy",  NUM_TASKS, average_over)
bwd_query_based_acc_0, bwd_query_based_std_0  = calculate_curve(base_path, runs, lr_index, "backward_accuracy",  NUM_TASKS, average_over)




lr_index, runs, NUM_TASKS, average_over = "0" , ["4"] , 50000, 10
base_path = os.path.join(project_root, "results", "cifar_100", "permuted", "query_based_cl", "task_balanced_replay")
