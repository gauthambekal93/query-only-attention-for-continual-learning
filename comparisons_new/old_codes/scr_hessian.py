...
def calculate_curve( base_path, config_id, seed_ids, key, num_tasks=None, average_over = 0):    
    ...
    for seed_id in seed_ids:
        ...
        out = _load_pickle(p)
        #out = torch.load(p, map_location='cpu')
...
plot_graph({ 
            ...
            #"CBP: effective_rank":  (effective_rank_cbp, effective_rank_std_cbp, {"color":"yellow", "linestyle": "-",  "marker": "s"}),
...
plot_graph({ 
            ...
            "CBP: Forward_Loss":  (forward_loss_query_based_fifo, forward_loss_std_query_based_fifo, {"color":"black", "linestyle": "-",  "marker": "s"}),

            },
             title="Slowly Changing Regression - Forward_Loss",
             ylabel = "Loss")

plot_graph({ 
            
            "CBP: Prequential_Loss":  (prequential_loss_query_based_fifo, prequential_loss_std_query_based_fifo, {"color":"black", "linestyle": "-",  "marker": "s"}),

            },
             title="Slowly Changing Regression - Prequential_Loss",
             ylabel = "Loss")