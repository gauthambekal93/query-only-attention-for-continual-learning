...
plot_graph({ 
            "BP":  (param_change_bp_acc, param_change_bp_std, {"color":"skyblue", "linestyle": "-",  "marker": "d"}),
            ...
            "Q_CL":  (param_change_qcl_acc, param_change_qcl_std, {"color":"black", "linestyle": "-",  "marker": "s"}),
            "Full-Attn":  (param_change_fatt_acc, param_change_fatt_std, {"color":"red", "linestyle": "-",  "marker": "s"}),

            
            },
             title="Permuted_MNIST - Param Change Over Tasks ",
             ylabel = "Param Change")
