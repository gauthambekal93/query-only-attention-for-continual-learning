...
plot_graph({ 
            ...
            "Q-CL":  (obj['prequential_qcl_acc'], obj['prequential_qcl_std'], {"color":"black", "linestyle": "-",  "marker": "s"}),
            "Full-Attn":  (obj['prequential_fatt_acc'], obj['prequential_fatt_std'], {"color":"red", "linestyle": "-",  "marker": "s"}),

            },
             title="Online Cifar 100 - Prequential Accuracy",
             ylabel = "Accuracy")    
...
plot_graph({ 
            ...
            "BP":  (obj['fwd_bp_acc'], obj['fwd_bp_std'], {"color":"skyblue", "linestyle": "-",  "marker": "s"}),
            ...
            "Exp_Rep":  (obj['fwd_er_replay'], obj['fwd_er_std'], {"color":"chocolate", "linestyle": "-",  "marker": "s"}),
            "DarkExp":  (obj['fwd_dark_exp_acc'], obj['fwd_dark_exp_std'], {"color":"magenta", "linestyle": "-",  "marker": "s"}),
            "Q-CL":  (obj['fwd_qcl_acc'], obj['fwd_qcl_std'], {"color":"black", "linestyle": "-",  "marker": "s"}),
            "Full-Attn":  (obj['fwd_fatt_acc'], obj['fwd_fatt_std'], {"color":"red", "linestyle": "-",  "marker": "s"}),

            },
             title="Online Cifar 100 - Forward Accuracy",
             ylabel = "Accuracy")
