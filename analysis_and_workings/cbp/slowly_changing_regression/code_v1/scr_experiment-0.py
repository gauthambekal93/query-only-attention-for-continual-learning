...
def import_modules():    
    ...
    from analysis_and_workings.cbp.slowly_changing_regression.code_v1.data_manager import DataManager 
    from analysis_and_workings.cbp.slowly_changing_regression.code_v1.runner import Runner 
    from analysis_and_workings.cbp.slowly_changing_regression.code_v1.checkpoint_manager import CheckpointManager 

    #from analysis_and_workings.cbp.slowly_changing_regression.code_v1.neural_net import feed_forward_nn
    from analysis_and_workings.cbp.slowly_changing_regression.code_v1.AdamGnT import AdamGnT
    from analysis_and_workings.cbp.slowly_changing_regression.code_v1.gnt import GnT
    from analysis_and_workings.cbp.slowly_changing_regression.code_v1.cbp import ContinualBackprop
    from analysis_and_workings.cbp.slowly_changing_regression.code_v1.ffnn import FFNN
