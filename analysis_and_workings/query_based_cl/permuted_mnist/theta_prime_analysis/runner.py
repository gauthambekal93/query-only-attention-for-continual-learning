...
class Runner:
    ...
    def prequential_testing(self, train_context, data_manager_obj, batch_x, batch_y):
        ...
        with torch.no_grad():
            predictions , delta = train_context.net.prediction(data_manager_obj, batch_x, batch_y)
    ...
    def forward_testing(self, train_context, data_manager_obj):
        ...
        with torch.no_grad():
            predictions, _ = train_context.net.prediction(data_manager_obj, batch_x, batch_y)
    ...
    def train(self, train_context, data_manager_obj, checkpoint_obj):
        ...
        train_accuracy, train_loss, prequential_accuracy, deltas = [], [], [], []
        ...
        for i in range(0, train_x.shape[0], self.num_datapoints_per_timestep ):
            ...
            if data_manager_obj.fifo_counter > 0 :
                ...
                acc, delta = self.prequential_testing(train_context, data_manager_obj, batch_x, batch_y)
        ...
        print("task id ", data_manager_obj.current_task_id, 
              ...
              "Prequential accuracy", prequential_accuracy, "Forward accuracy: ", forward_accuracy,  "Backward accuracy: ", backward_accuracy , "Deltas ", deltas)
        
        return train_loss, train_accuracy, prequential_accuracy, forward_accuracy, backward_accuracy, deltas
    ...
    def run(self, train_context, data_manager_obj, checkpoint_obj):
        ...
        while data_manager_obj.current_task_id < data_manager_obj.num_tasks: 
            ...
            if  ( data_manager_obj.current_task_id >= data_manager_obj.num_old_task_window ) :
                ...
                train_loss, train_accuracy, prequential_accuracy, forward_accuracy, backward_accuracy, deltas = self.train( train_context, data_manager_obj, checkpoint_obj)
                
                checkpoint_obj.save_model_checkpoint( train_context, data_manager_obj, train_loss, data_manager_obj.current_task_id)
                
                checkpoint_obj.save_result_checkpoint(data_manager_obj, train_loss, train_accuracy, prequential_accuracy, forward_accuracy, backward_accuracy, deltas)
