...
class CheckpointManager:
    ...
    def __init__(self, data_manager_obj, runner_obj, root, model_dir ):
        ...
        self.results_dict["param_change"] = {} 
        self.results_dict["param_size"] = {}     
    ...
    def save_result_checkpoint(self,  data_manager_obj, train_loss, train_accuracy, prequential_accuracy, forward_accuracy, backward_accuracy, param_change, param_size):
        ...
        try:
            ...
            self.results_dict["param_change"][current_task_id] = param_change
            self.results_dict["param_size"] [current_task_id] = param_size
    ...
    def load_experiment_checkpoint(self, train_context, data_manager_obj):
        ...
        if os.path.exists(self.result_path):        
            ...
            data_manager_obj.param_change = self.results_dict["param_change"]
            data_manager_obj.param_size = self.results_dict["param_size"]
