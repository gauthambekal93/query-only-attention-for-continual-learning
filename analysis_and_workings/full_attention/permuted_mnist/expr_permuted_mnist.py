...
def import_modules():
    ...
    from analysis_and_workings.full_attention.permuted_mnist.data_manager import DataManager 
    from analysis_and_workings.full_attention.permuted_mnist.runner import Runner 
    from analysis_and_workings.full_attention.permuted_mnist.checkpoint_manager import CheckpointManager 
    from analysis_and_workings.full_attention.permuted_mnist.neural_networks import ERNetwork
