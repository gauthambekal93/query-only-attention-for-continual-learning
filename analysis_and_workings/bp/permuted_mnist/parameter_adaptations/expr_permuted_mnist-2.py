...
def import_modules():
    ...
    from analysis_and_workings.bp.permuted_mnist.parameter_adaptations.data_manager import DataManager 
    from analysis_and_workings.bp.permuted_mnist.parameter_adaptations.runner import Runner 
    from analysis_and_workings.bp.permuted_mnist.parameter_adaptations.checkpoint_manager import CheckpointManager 
    from analysis_and_workings.bp.permuted_mnist.parameter_adaptations.neural_networks import ERNetwork
