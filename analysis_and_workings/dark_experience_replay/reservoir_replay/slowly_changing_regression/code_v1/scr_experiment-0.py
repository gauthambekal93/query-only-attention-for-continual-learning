...
def import_modules():    
    ...
    from analysis_and_workings.dark_experience_replay.reservoir_replay.slowly_changing_regression.code_v1.data_manager import DataManager 
    from analysis_and_workings.dark_experience_replay.reservoir_replay.slowly_changing_regression.code_v1.runner import Runner 
    from analysis_and_workings.dark_experience_replay.reservoir_replay.slowly_changing_regression.code_v1.checkpoint_manager import CheckpointManager 

    from analysis_and_workings.dark_experience_replay.reservoir_replay.slowly_changing_regression.code_v1.neural_net import feed_forward_nn
...
class SCRExperiment:
    ...
    def initialize_data_manager(self):
         self.data_manager_obj = DataManager(self.train_context.device, ROOT, self.data_dir, self.flip_after, self.num_data_points,
                                             ...
                                             self.buffer_size, self.samples_from_buffer)
