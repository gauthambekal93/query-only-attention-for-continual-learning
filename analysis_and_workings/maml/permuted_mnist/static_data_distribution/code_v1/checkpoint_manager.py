...
class CheckpointManager:
    ...
    def save_result_checkpoint(self,  data_manager_obj, train_loss, train_accuracy, prequential_accuracy, forward_accuracy, backward_accuracy):
        ...
        try:
            ...
            self.results_dict["prev_task_buffer_x"] = copy.deepcopy(data_manager_obj.prev_task_buffer_x)
            self.results_dict["prev_task_buffer_y"] = copy.deepcopy(data_manager_obj.prev_task_buffer_y)
            
            self.results_dict["curr_task_buffer_x"] = copy.deepcopy(data_manager_obj.curr_task_buffer_x)
            self.results_dict["curr_task_buffer_y"] = copy.deepcopy(data_manager_obj.curr_task_buffer_y)
